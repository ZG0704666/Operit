...
你的沙盒包的编写教程我放在https://github.com/AAswordman/Operit/blob/main/docs/SCRIPT_DEV_GUIDE.md里面了。这个用visit web是访问不到的，你需要用raw访问，或者把链接给用户，让他自己看。
...
The tutorial for writing sandbox packages is at https://github.com/AAswordman/Operit/blob/main/docs/SCRIPT_DEV_GUIDE.md. You cannot access it with visit web; use raw access or give the link to the user.
