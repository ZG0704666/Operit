...
async function list_sandbox_packages() {
    ...
    try {
        ...
        const payload = (_a = result === null || result === void 0 ? void 0 : result.value) !== null && _a !== void 0 ? _a : "";
        complete({
            success: true,
...
async function set_sandbox_package_enabled(params) {
    ...
    try {
        ...
        const payload = (_c = result === null || result === void 0 ? void 0 : result.value) !== null && _c !== void 0 ? _c : "";
        complete({
            success: true,
        ...
        complete({
            success: false,
            message: (_d = error === null || error === void 0 ? void 0 : error.message) !== null && _d !== void 0 ? _d : "Unknown error"
        });
    }
}
async function read_environment_variable(params) {
    ...
    try {
        ...
        const raw = (_b = result === null || result === void 0 ? void 0 : result.value) !== null && _b !== void 0 ? _b : "";
        let parsed = null;
        try {
...
async function write_environment_variable(params) {
    ...
    try {
        ...
        const raw = (_c = result === null || result === void 0 ? void 0 : result.value) !== null && _c !== void 0 ? _c : "";
        let parsed = null;
        try {
            parsed = raw ? JSON.parse(raw) : null;
        }
        ...
        complete({
            ...
            data: {
                ...
                value: (_d = parsed === null || parsed === void 0 ? void 0 : parsed.value) !== null && _d !== void 0 ? _d : null,
                exists: !!(parsed === null || parsed === void 0 ? void 0 : parsed.exists),
                raw
            }
        });
        ...
        complete({
            success: false,
            message: (_e = error === null || error === void 0 ? void 0 : error.message) !== null && _e !== void 0 ? _e : "Unknown error"
        });
    }
}
async function restart_mcp_with_logs(params) {
    ...
    try {
        ...
        const logs = (_a = result === null || result === void 0 ? void 0 : result.value) !== null && _a !== void 0 ? _a : "";
        complete({
            success: true,
...
async function set_function_model_config(params) {
    ...
    try {
        ...
        complete({
            success: false,
            message: (_c = error === null || error === void 0 ? void 0 : error.message) !== null && _c !== void 0 ? _c : "Unknown error"
        });
    }
}
